...
/**
 * Counts occurrances of combinations of input data.
 *
 * @author Alex Fraser
 */
@Description(name = "Accountant", description = "Counts occurrances of combinations of input data. This is a pass-through filter with metadata collection.")

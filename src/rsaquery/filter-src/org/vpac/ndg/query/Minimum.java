...
@Description(name = "Minimum", description = "Returns the smaller value of its"
		+ " inputs. Can also be used as an 'and' filter for boolean data.")
...
public class Minimum implements Filter {
	...
	public void kernel(VectorReal coords) throws IOException {
		min.minOf(inputA.getPixel(coords), inputB.getPixel(coords));
		output.set(min);
	}
}
